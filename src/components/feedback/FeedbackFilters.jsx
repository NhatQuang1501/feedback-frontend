        ...
        <div>
          ...
          {activeFiltersCount > 0 && (
            <Button
              ...
              className="px ml-2 text-blue-600 hover:text-blue-800"
            >
              Xóa bộ lọc
            </Button>
          )}
        ...
        <Box className="flex flex-wrap gap-2 border-t border-gray-200 pt-4">
          ...
          {filters.q && (
            <Chip
              ...
              className="bg-blue-50 p-4 text-blue-800"
            />
          )}
            ...
            filters.type.map((typeValue) => {
              ...
              return (
                <Chip
                  ...
                  className="bg-green-50 p-4 text-green-800"
                />
              );
            })}
            ...
            filters.priority.map((priorityValue) => {
              ...
              return (
                <Chip
                  ...
                  className="bg-yellow-50 p-4 text-yellow-800"
                />
              );
            })}
            ...
            filters.status.map((statusValue) => {
              ...
              return (
                <Chip
                  ...
                  className="bg-purple-50 p-4 text-purple-800"
                />
              );
            })}
