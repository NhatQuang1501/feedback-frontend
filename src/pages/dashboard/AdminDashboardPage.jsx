...
export default function AdminDashboardPage() {
  ...
  return (
    <>
      {/* Header */}
      <Typography className="text-lg font-bold" sx={{ mb: 2 }}>
        Dashboard Quản Trị
      </Typography>

      {/* Thống kê */}
      <Grid container spacing={14} sx={{ mb: 6 }} columns={{ xs: 12, sm: 12, md: 12, lg: 15 }}>
      ...
      {/* Khoảng cách giữa StatCard và Chart đầu tiên */}
      <Box sx={{ height: 48, mb: 0 }} />
      ...
      {/* Khoảng cách giữa chart và bảng */}
      <Box sx={{ height: 48, mb: 0 }} />
